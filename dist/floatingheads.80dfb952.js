...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/nipplejs/dist/nipplejs.js":[function(require,module,exports) {
var define;
...
},{}],"../Components/Blaster.js":[function(require,module,exports) {
...
function () {
  function Blaster(ship) {
    ...
    this._base.style.transform = "rotate(-".concat(ship.degrees, "deg)");
  ...
  _createClass(Blaster, [{
    key: "fire",
    value: function fire(target, player) {
      var _this = this;
      ...
      this._base.style.left = "".concat(this._x, "px");
      this._base.style.bottom = "".concat(this._y, "px");

      var blaster = this._base.getBoundingClientRect();

      var blasterTarget = document.getElementById(target.id).lastElementChild.getBoundingClientRect(); //TODO: Recalculate the hit based on radius.

      var hit = blaster.top > blasterTarget.bottom || blaster.right < blasterTarget.left || blaster.bottom < blasterTarget.top || blaster.left > blasterTarget.right;

      if (!hit) {
        target.health = target.health - 5;

        if (player) {
          document.getElementById('health').lastElementChild.innerHTML = target.health;
        } else {
          document.getElementById('opponent-health').lastElementChild.innerHTML = target.health;
        }
      ...
      if (this._x < -50 || this._x > this._playAreaWidth || this._y < -50 || this._y > this._playAreaHeight) {
        this.remove();
        return;
      }

      requestAnimationFrame(function () {
        return _this.fire(target, player);
      });
    }
  }, {
    key: "remove",
...
},{}],"../Components/Ship.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function Ship(state, player) {
    ...
    polygon.setAttributeNS(null, 'style', "fill:".concat(state.color, ";stroke:").concat(state.color, ";stroke-width:1"));
    svg.appendChild(polygon);

    this._ship.appendChild(svg);

    playArea.appendChild(this._ship);
    this._ship.style.bottom = "".concat(this._state.bottom, "px");
    this._ship.style.left = "".concat(this._state.left, "px");
    this._ship.style.transform = "rotate(-".concat(this._state.degrees, "deg)");
  ...
  _createClass(Ship, [{
    ...
    value: function move(state) {
      this._ship.style.transform = "rotate(-".concat(state.degrees, "deg)");

      if (state.rawDistance > 25) {
        var x = (Math.cos(state.radians) * state.distance).toFixed(2);
        var y = (Math.sin(state.radians) * state.distance).toFixed(2);
        state.left = state.left + parseFloat(x);
        state.bottom = state.bottom + parseFloat(y);

        if (state.left > state.playAreaWidth) {
          state = Object.assign(state, {
            bottom: state.bottom - Math.tan(state.radians) * state.playAreaWidth,
            left: -50
          });
        ...
        if (state.bottom > state.playAreaHeight) {
          state = Object.assign(state, {
            left: state.left - Math.tan(state.cRadians) * state.playAreaHeight,
            bottom: -50
          });
        ...
        this._ship.style.left = "".concat(state.left, "px");
        this._ship.style.bottom = "".concat(state.bottom, "px");
      }
    }
  }, {
    key: "fire",
    value: function fire(_ref) {
      var shooter = _ref.shooter,
          target = _ref.target;

      if (this._player) {
        var blaster = new Blaster(shooter);
        blaster.fire(target, this._player);
        shooter = Object.assign(shooter, {
          shots: shooter.shots - 1
        });
        var shots = document.getElementById('shots').lastElementChild;
        ...
        var _blaster = new Blaster(shooter);

        _blaster.fire(target, this._player);
...
module.exports = Ship;
},{"./Blaster":"../Components/Blaster.js"}],"../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
var joystick = require('nipplejs');

var Ship = require('./Components/Ship');

var _ = require('lodash'); //Global variables.


var connection;
var opponentShip;
var playerShip;
var isPlayerOne = true; //Wait until the peerjs file has been loaded.

window.addEventListener('load', function () {
  var vh = window.innerHeight * 0.01;
  document.documentElement.style.setProperty('--vh', "".concat(vh, "px"));
  var peerForm = document.getElementById('peer-id-form');
  ...
  var playerOne = new Proxy(playerOneBase, {
  ...
  var playerTwo = new Proxy(playerTwoBase, {
    get: function get(target, prop) {
      return Reflect.get(target, prop);
    },
    set: function set(target, prop, value) {
  ...
  playerShip = new Ship(playerOne, true); //Form to get ID of peer, you are playerOne.

  peerForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var opponentID = peerIDInput.value;
    peerForm.reset(); //Connect to the opponent.
  ...
  var leftJoystick = joystick.create(options);
  leftJoystick.on('move', function (e, joystick) {
    if (isPlayerOne) {
  ...
  var rightTrigger = document.getElementById('trigger');
  rightTrigger.addEventListener('touchstart', function () {
  ...
  rightTrigger.addEventListener('touchend', function () {
    rightTrigger.classList.remove('fired');
  });
});
},{"./index.scss":"../index.scss","nipplejs":"../node_modules/nipplejs/dist/nipplejs.js","./Components/Ship":"../Components/Ship.js","lodash":"../node_modules/lodash/lodash.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/floatingheads.80dfb952.js.map